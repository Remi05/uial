...
internal class LiveUITreeNode : IUITreeNode
{
    ...
    private ElementPropertiesProvider ElementPropertiesProvider { get; set; }
    ...
    public LiveUITreeNode(IUIAutomationElement automationElement, ElementPropertiesProvider elementPropertiesProvider, IUIAutomationCondition childrenFilterCondition)
    {
