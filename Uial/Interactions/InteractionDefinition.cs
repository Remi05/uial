...
namespace Uial.Interactions
{
    public class InteractionDefinition : IInteractionDefinition
    {
        ...
        public IInteraction Resolve(IContext parentContext, IInteractionsProvider interactionsProvider, IEnumerable<string> paramValues)
        {
            ...
            IEnumerable<IInteraction> interactions = BaseInteractionDefinitions.Select((interactionDefinition) => interactionDefinition.Resolve(parentContext, interactionsProvider, currentScope));
