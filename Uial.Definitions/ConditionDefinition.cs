...
namespace Uial.Definitions
{
    ...
    {
        private IEnumerable<PropertyConditionDefinition> PropertyConditions { get; set; }
        ...
        public ConditionDefinition(IEnumerable<PropertyConditionDefinition> propertyConditions)
        {
            ...
            {
                throw new ArgumentException($"Parameter \"{nameof(propertyConditions)}\" must contain at least one PropertyConditionDefinition.");
            }
