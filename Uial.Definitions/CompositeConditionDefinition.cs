...
namespace Uial.Definitions
{
    ...
    {
        public IEnumerable<ConditionDefinition> PropertyConditions { get; private set; }

        public CompositeConditionDefinition(IEnumerable<ConditionDefinition> propertyConditions)
        {
